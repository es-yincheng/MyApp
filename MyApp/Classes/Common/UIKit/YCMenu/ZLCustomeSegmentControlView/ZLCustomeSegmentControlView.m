...
- (void)customeData {
    ...
    if (_titlesCustomeColor == nil) {
        _titlesCustomeColor = [UIColor flatBlackColor];
    }
    
    if (_titlesHeightLightColor == nil) {
        _titlesHeightLightColor = [UIColor flatWhiteColor];
    }
    
    if (_backgroundHeightLightColor == nil) {
        _backgroundHeightLightColor = [UIColor flatGreenColor];
    }
...
- (void) createBottomLabels {
    for (int i = 0; i < _titles.count; i ++) {
        ...
        tempLabel.backgroundColor = [UIColor flatForestGreenColor];
